...
public class FirebaseNotification {
    ...
    public static void notify(final Context context,
        ...
        final Bitmap picture = BitmapFactory.decodeResource(res, R.drawable.mac);


        final String ticker = notificationTitle;
        final String title = notificationTitle;
        final String text = notificationText;
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setStyle(new NotificationCompat.BigTextStyle()
                        ...
                        .setSummaryText("Manga and Anime CLub"))
